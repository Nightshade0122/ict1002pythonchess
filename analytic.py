...
def graphTypes(pgnlist):
    ...
    if len(pgnlist) != 0:
        while True:
            ...
            print("Enter 3 to display bar chart of Top 5 Time Control used")
            print("Enter 4 to display chart of Winning rate")
            ...
            if 0 <= choice <= 5:
                if choice == 0:
                    ...
                    title  = "Top "+ str(datacount) + "Opening"
                    barGraph(opening,datacount,title,"Type of Openings","No. of Times")
                    ...
                    barGraph(timeControl,5,"Most Common Time Control Used","Type of Time Control","No. of Times")
...
#newpgn = search.query_database(pgn,search.enter_search())
#graphTypes(pgnlist)
opening = getOpening(pgnlist)
